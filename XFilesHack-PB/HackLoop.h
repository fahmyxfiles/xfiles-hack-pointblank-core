...
{	 
	if(IsInBattle()){
		...
		//==============================================================================================================================================
		if(FeatureStruct->GameHack.ReplaceWeapon.Status){
			FeatureStruct->GameHack.Assist.Mode = 0;
			
			if(IsKeyboardKeyDownOnce(DIK_LSHIFT)){
				_WeaponValue WP(ReplaceWeapon->GetValueByIndex(FeatureStruct->GameHack.ReplaceWeapon.SelectWeapon));
				LocalChara->setCharaWeapon(0, WP.WeaponType(), WP.WeaponIndex());
			}
		...
		if(FeatureStruct->GameHack.ReplaceWeapon.AutoTeleport)
		{
			if(IsKeyboardKeyDownOnce(DIK_SPACE)){
				for(int i = 0; i <= 15; i++){
		...
		if(FeatureStruct->GameHack.PlayerSelect.KickPlayer)
		{
			CGameCharaBase* Chara = pGameCharaManager->getCharaByNickname(FeatureStruct->GameHack.PlayerSelect.Nickname);
			if(Chara > NULL){
				static DWORD dwTick = NULL;
				if(dwTick <= GetTickCount()){
					pGameContext->setEvent(EventCode.Whisper, FeatureStruct->GameHack.PlayerSelect.Nickname, "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@BY XFILES@@@@@@@@@@@@@@", NULL, NULL, NULL);
					dwTick = GetTickCount() + 2000;
				}
			}
			else FeatureStruct->GameHack.PlayerSelect.KickPlayer = 0;
		}
		...
		FeatureStruct->GameHack.PlayerSelect.KickPlayer = 0;
	}
	//==============================================================================================================================================
